    ...
    <div className="group relative rounded-2xl overflow-hidden bg-black/5 shadow-sm ring-1 ring-black/5">
      ...
      {onDelete && (
        <button
          ...
          className="absolute top-3 right-3 rounded-full bg-white/90 backdrop-blur px-3 py-1 text-sm font-medium text-gray-900 shadow hover:bg-white focus:outline-none focus-visible:ring-2 focus-visible:ring-black/30"
